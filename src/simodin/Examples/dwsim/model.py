...
class dwsim_model(link.SimModel):
    def init_model(self, **params):
        ...
        self.interf = DWSIM.Automation.Automation3()
        ...
        m1 =self.model.AddObject(DWSIM.Interfaces.Enums.GraphicObjects.ObjectType.MaterialStream, 50, 50, "inlet")
        m2 =self.model.AddObject(DWSIM.Interfaces.Enums.GraphicObjects.ObjectType.MaterialStream, 150, 50, "outlet")
        e1 =self.model.AddObject(DWSIM.Interfaces.Enums.GraphicObjects.ObjectType.EnergyStream, 100, 50, "power")
        h1 =self.model.AddObject(DWSIM.Interfaces.Enums.GraphicObjects.ObjectType.Heater, 100, 50, "heater")
        ...
        stables = DWSIM.Thermodynamics.PropertyPackages.SteamTablesPropertyPackage()
        ...
        h1.CalcMode = DWSIM.UnitOperations.UnitOperations.Heater.CalculationMode.OutletTemperature
    ...
    def calculate_model(self, **model_params):
        ...
        self.DWSIM.GlobalSettings.Settings.SolverMode = 0
